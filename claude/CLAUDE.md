...
Agent-tool worktrees (`isolation: worktree`) branch from the **session-start snapshot** and not current HEAD. Commits that landed mid-session are invisible to later agents.
